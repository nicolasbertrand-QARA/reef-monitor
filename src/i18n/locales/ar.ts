export default {
  ...
  dashboard: { waterChemistry: 'كيمياء المياه', nutrients: 'المغذيات', ratioNO3PO4: 'نسبة NO3:PO4', ionicBalance: 'التوازن الأيوني', noData: 'لا توجد بيانات', alkSwing: 'تقلب القلوية' },
