export default {
  ...
  trends: { history: '历史记录', noReadings: '该期间无测量值', deleteTitle: '删除测量值', deleteMessage: '%{date}的%{value} %{unit}？', deleteConfirm: '删除', consumptionInlineRising: '每天约上升 %{rate} %{unit}。请检查滴定。', rangeDays: '%{n}天', rangeAll: '全部', },
