export default {
  ...
  settings: { thresholds: '警报阈值', data: '数据', dosingLog: '添加记录', exportCsv: '导出CSV', noDataExport: '无数据', noDataExportMsg: '没有可导出的测量值。', save: '保存', warnLow: '警告下限', warnHigh: '警告上限', critLow: '危急下限', critHigh: '危急上限' },
