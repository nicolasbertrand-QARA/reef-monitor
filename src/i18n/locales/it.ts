export default {
  ...
  dashboard: { waterChemistry: "Chimica dell'acqua", nutrients: 'Nutrienti', ratioNO3PO4: 'Rapporto NO3:PO4', ionicBalance: 'Equilibrio ionico', noData: 'nessun dato' },
  ...
  trends: { consumptionRate: 'Tasso di consumo', consumptionHigh: 'Consumo elevato — coralli in crescita attiva', consumptionNormal: 'Normale — assorbimento costante', consumptionStable: 'Stabile — nessuna variazione netta', consumptionRising: 'In aumento — verificare dosaggio', history: 'Cronologia', noReadings: 'Nessuna lettura in questo periodo', deleteTitle: 'Elimina lettura', deleteMessage: '%{value} %{unit} del %{date}?', deleteConfirm: 'Elimina' },
