export default {
  ...
  settings: { thresholds: '알림 임계값', data: '데이터', dosingLog: '첨가 기록', exportCsv: 'CSV 내보내기', noDataExport: '데이터 없음', noDataExportMsg: '내보낼 측정값이 없습니다.', save: '저장', warnLow: '경고 하한', warnHigh: '경고 상한', critLow: '위험 하한', critHigh: '위험 상한' },
